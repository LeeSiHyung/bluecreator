...
public class LinkedListTester {
	...
	static Menu SelectMenu() {
		...
		do {
			for(Menu m : Menu.values()) {
				...
				// 3개 순으로 라인을 나누기 위해 처리
				// m.ordinal을 3개씩 나누고 0부터 시작했기 때문에 2일대 나머지 2 5일 때 나머지 2 8일때 나머지 2순으로 처리된다.
	...
	public static void main(String[] args) {
		...
		//System.out.println(Data.NO | Data.NAME);
		//System.out.println(3 & Data.NO);
